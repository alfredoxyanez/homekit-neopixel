...
rgbs = [[0,0,100,255,255,255],[0,0,100,255,255,255],[0,0,100,255,255,255],[0,0,100,255,255,255]]
...
def on_connect(client, userdata, flags, rc):
    ...
    global strip3
    global strip4
    strip1 = Adafruit_NeoPixel(LED_COUNT, 12, LED_FREQ_HZ, LED_DMA, LED_INVERT, LED_BRIGHTNESS, 0)
    ...
    client.subscribe('test/three')
    client.subscribe('test/four')
        #Light1
    ...
    client.subscribe("light2/saturation")
        #Light3
    client.subscribe("light3/report/status")
    client.subscribe("light3/status")
    client.subscribe("light3/report/brightness")
    client.subscribe("light3/brightness")
    client.subscribe("light3/report/hue")
    client.subscribe("light3/hue")
    client.subscribe("light3/report/saturation")
    client.subscribe("light3/saturation")
        #Light4
    client.subscribe("light4/report/status")
    client.subscribe("light4/status")
    client.subscribe("light4/report/brightness")
    client.subscribe("light4/brightness")
    client.subscribe("light4/report/hue")
    client.subscribe("light4/hue")
    client.subscribe("light4/report/saturation")
    client.subscribe("light4/saturation")
...
def on_message(client, userdata, msg):
	...
	print(str(strip1))
	print(vars(strip1))
	print(strip1._led_data.channel)
	print(dir(strip1._channel))
	print(strip1._channel.__class__)
